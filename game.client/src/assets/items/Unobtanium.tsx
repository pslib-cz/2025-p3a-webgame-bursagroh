...
type UnobtaniumProps = AssetProps & Omit<React.SVGProps<SVGSVGElement>, "x" | "y" | "width" | "height" | "viewBox" | "xmlns">

const Unobtanium: React.FC<UnobtaniumProps> = ({ x, y, width, height, ...props }) => {
    return (
