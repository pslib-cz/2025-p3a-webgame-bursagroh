...
type RockItemProps = AssetProps & Omit<React.SVGProps<SVGSVGElement>, "x" | "y" | "width" | "height" | "viewBox" | "xmlns">

const RockItem: React.FC<RockItemProps> = ({ x, y, width, height, ...props }) => {
    return (
