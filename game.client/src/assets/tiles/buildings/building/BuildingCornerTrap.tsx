...
type BuildingCornerTrapProps = {rotation: "0deg" | "90deg" | "180deg" | "270deg"} & AssetProps & Omit<React.SVGProps<SVGSVGElement>, "x" | "y" | "width" | "height" | "viewBox" | "xmlns">

const BuildingCornerTrap: React.FC<BuildingCornerTrapProps> = ({ x, y, width, height, rotation, ...props }) => {
    return (
        <svg {...props} x={x} y={y} width={width} height={height} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" style={{rotate: rotation, transformOrigin: `${x + width / 2}px ${y + height / 2}px`}}>
            <rect width="64" height="64" fill="#710000" />
            <rect x="64" width="64" height="64" fill="#590000" />
            <rect x="128" width="64" height="64" fill="#590000" />
            <rect x="192" width="64" height="64" fill="#590000" />
            <rect x="256" width="64" height="64" fill="#590000" />
            <rect x="320" width="64" height="64" fill="#590000" />
            ...
            <rect x="64" y="64" width="64" height="64" fill="#590000" />
            <rect x="128" y="64" width="64" height="64" fill="#590000" />
            <rect x="192" y="64" width="64" height="64" fill="#590000" />
            <rect x="256" y="64" width="64" height="64" fill="#590000" />
            <rect x="320" y="64" width="64" height="64" fill="#590000" />
            <rect x="384" y="64" width="64" height="64" fill="#590000" />
            ...
            <rect x="64" y="320" width="64" height="64" fill="#710000" />
            ...
            <rect x="64" y="384" width="64" height="64" fill="#710000" />
            <rect x="128" y="384" width="64" height="64" fill="#710000" />
            <rect x="192" y="384" width="64" height="64" fill="#710000" />
...
export default BuildingCornerTrap
