...
const Chest: React.FC = () => {
    return (
        <svg id={assetTypeToId("chest")} x={0} y={0} width="100%" height="100%" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="320" width="64" height="64" fill="black" />
            <rect x="384" width="64" height="64" fill="black" />
            ...
            <rect x="448" y="64" width="64" height="64" fill="black" />
            ...
            <rect x="448" y="128" width="64" height="64" fill="black" />
            ...
            <rect x="256" y="192" width="64" height="64" fill="white" />
            <rect x="320" y="192" width="64" height="64" fill="black" />
            <rect x="384" y="192" width="64" height="64" fill="black" />
            <rect x="448" y="192" width="64" height="64" fill="black" />
            <rect y="256" width="64" height="64" fill="black" />
            ...
            <rect y="320" width="64" height="64" fill="black" />
            ...
            <rect y="384" width="64" height="64" fill="black" />
            ...
            <rect x="448" y="384" width="64" height="64" fill="black" />
            <rect y="448" width="64" height="64" fill="black" />
            <rect x="64" y="448" width="64" height="64" fill="black" />
            <rect x="128" y="448" width="64" height="64" fill="black" />
            <rect x="192" y="448" width="64" height="64" fill="black" />
            <rect x="256" y="448" width="64" height="64" fill="black" />
            <rect x="320" y="448" width="64" height="64" fill="black" />
            <rect x="384" y="448" width="64" height="64" fill="black" />
            <rect x="448" y="448" width="64" height="64" fill="black" />
        </svg>
    )
}
