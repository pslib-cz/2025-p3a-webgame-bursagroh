...
type UnobtainiumOreProps = AssetProps & Omit<React.SVGProps<SVGSVGElement>, "x" | "y" | "width" | "height" | "viewBox" | "xmlns">

const UnobtainiumOre: React.FC<UnobtainiumOreProps> = ({ x, y, width, height, ...props }) => {
    return (
        <svg {...props} x={x} y={y} width={width} height={height} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="320" y="64" width="64" height="64" fill="white" />
            ...
            <rect x="64" y="320" width="64" height="64" fill="white" />
            ...
            <rect x="384" y="320" width="64" height="64" fill="white" />
