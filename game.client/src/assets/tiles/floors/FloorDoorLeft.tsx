...
type FloorDoorLeftProps = {rotation: "0deg" | "90deg" | "180deg" | "270deg"} & AssetProps & Omit<React.SVGProps<SVGSVGElement>, "x" | "y" | "width" | "height" | "viewBox" | "xmlns">

const FloorDoorLeft: React.FC<FloorDoorLeftProps> = ({ x, y, width, height, rotation, ...props }) => {
    return (
