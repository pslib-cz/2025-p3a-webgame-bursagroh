...
const FloorDoorLeft: React.FC = () => {
    return (
        <>
            <svg id={assetTypeToId("wall-door-left-bottom")} x={0} y={0} width="100%" height="100%" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <g transform="rotate(0 256 256)">
                    ...
                    <rect x="320" y="384" width="64" height="64" fill="#A1A0A0" />
                    <rect x="384" y="384" width="64" height="64" fill="#A1A0A0" />
                    ...
                    <rect x="192" y="448" width="64" height="64" fill="#A1A0A0" />
                    <rect x="256" y="448" width="64" height="64" fill="#A1A0A0" />
                    <rect x="320" y="448" width="64" height="64" fill="#A1A0A0" />
                    <rect x="384" y="448" width="64" height="64" fill="#A1A0A0" />
                    ...
                    <rect x="192" y="384" width="64" height="64" fill="#A1A0A0" />
                    <rect x="256" y="384" width="64" height="64" fill="#A1A0A0" />
                </g>
            </svg>{" "}
            <svg id={assetTypeToId("wall-door-left-left")} x={0} y={0} width="100%" height="100%" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg id={assetTypeToId("wall-door-left-top")} x={0} y={0} width="100%" height="100%" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg id={assetTypeToId("wall-door-left-right")} x={0} y={0} width="100%" height="100%" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
