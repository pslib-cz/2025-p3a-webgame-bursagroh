...
const Floor: React.FC<FloorProps> = ({ x, y, width, height, ...props }) => {
    return (
        <svg {...props} x={x} y={y} width={width} height={height} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="64" y="384" width="64" height="64" fill="#A1A0A0" />
            <rect x="128" y="384" width="64" height="64" fill="#A1A0A0" />
            ...
            <rect x="64" y="448" width="64" height="64" fill="#A1A0A0" />
            <rect x="128" y="448" width="64" height="64" fill="#A1A0A0" />
